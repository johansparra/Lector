...
import com.ing_sebasparra.lector.TarjetaCredito.CardSelector;
...
public class CardCVVFragment extends CreditCardFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle state) {
        View v = inflater.inflate(R.layout.t_lyt_card_cvv, group, false);
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (s.length() == mMaxCVV) {
          ...
          //  onComplete(); //PARA QUE NO SIGA DE UNA AL PONER LOS 3 NUMEROS
        }
