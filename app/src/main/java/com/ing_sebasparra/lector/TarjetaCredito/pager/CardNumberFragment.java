...
import static com.ing_sebasparra.lector.TarjetaCredito.CreditCardUtils.CARD_NUMBER_FORMAT;
import static com.ing_sebasparra.lector.TarjetaCredito.CreditCardUtils.CARD_NUMBER_FORMAT_AMEX;
...
public class CardNumberFragment extends CreditCardFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle state) {
        View v = inflater.inflate(R.layout.t_lyt_card_number, group, false);
