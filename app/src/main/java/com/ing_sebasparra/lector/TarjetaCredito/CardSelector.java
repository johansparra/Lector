...
public class CardSelector {
    ...
    public static final CardSelector VISA = new CardSelector(R.drawable.z_card_color_round_rect_purple, R.drawable.z_chip, R.drawable.z_chip_inner, android.R.color.transparent, R.drawable.z_ic_billing_visa_logo, CardSelector.CVV_LENGHT_DEFAULT);
    public static final CardSelector MASTER = new CardSelector(R.drawable.z_card_color_round_rect_pink, R.drawable.z_chip_yellow, R.drawable.z_chip_yellow_inner, android.R.color.transparent, R.drawable.z_ic_billing_mastercard_logo, CardSelector.CVV_LENGHT_DEFAULT);
    public static final CardSelector AMEX = new CardSelector(R.drawable.z_card_color_round_rect_green, android.R.color.transparent, android.R.color.transparent, R.drawable.z_img_amex_center_face, R.drawable.z_ic_billing_amex_logo1, CardSelector.CVV_LENGHT_AMEX);
    public static final CardSelector DISCOVER = new CardSelector(R.drawable.z_card_color_round_rect_brown, android.R.color.transparent, android.R.color.transparent, android.R.color.transparent, R.drawable.z_ic_billing_discover_logo, CardSelector.CVV_LENGHT_DEFAULT);
    public static final CardSelector DEFAULT = new CardSelector(R.drawable.z_card_color_round_rect_default, R.drawable.z_chip, R.drawable.z_chip_inner, android.R.color.transparent, android.R.color.transparent, CardSelector.CVV_LENGHT_DEFAULT);
    ...
    public static CardSelector selectCard(String cardNumber) {
        if (cardNumber != null && cardNumber.length() >= 1) {
            ...
            if ((selector != DEFAULT) && (cardNumber.length() >= 3)) {
                int[] drawables = {R.drawable.z_card_color_round_rect_brown, R.drawable.z_card_color_round_rect_green, R.drawable.z_card_color_round_rect_pink, R.drawable.z_card_color_round_rect_purple, R.drawable.z_card_color_round_rect_blue};
                ...
                int[] chipOuter = {R.drawable.z_chip, R.drawable.z_chip_yellow, android.R.color.transparent};
                int[] chipInner = {R.drawable.z_chip_inner, R.drawable.z_chip_yellow_inner, android.R.color.transparent};
